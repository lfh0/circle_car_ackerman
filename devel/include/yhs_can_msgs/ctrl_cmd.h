...
struct ctrl_cmd_
{
  ...
  _ctrl_cmd_gear_type ctrl_cmd_gear;
   ...
   typedef float _ctrl_cmd_linear_type;
  _ctrl_cmd_linear_type ctrl_cmd_linear;

   typedef float _ctrl_cmd_angular_type;
  _ctrl_cmd_angular_type ctrl_cmd_angular;

   typedef float _ctrl_cmd_slipangle_type;
  _ctrl_cmd_slipangle_type ctrl_cmd_slipangle;
...
bool operator==(const ::yhs_can_msgs::ctrl_cmd_<ContainerAllocator1> & lhs, const ::yhs_can_msgs::ctrl_cmd_<ContainerAllocator2> & rhs)
{
  return lhs.ctrl_cmd_gear == rhs.ctrl_cmd_gear &&
    lhs.ctrl_cmd_linear == rhs.ctrl_cmd_linear &&
    lhs.ctrl_cmd_angular == rhs.ctrl_cmd_angular &&
    lhs.ctrl_cmd_slipangle == rhs.ctrl_cmd_slipangle;
}
...
struct MD5Sum< ::yhs_can_msgs::ctrl_cmd_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xcea8aa41b6a865fbULL;
  static const uint64_t static_value2 = 0xd2628e5a43e04d12ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::yhs_can_msgs::ctrl_cmd_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.ctrl_cmd_linear);
      stream.next(m.ctrl_cmd_angular);
      stream.next(m.ctrl_cmd_slipangle);
    }
...
struct Printer< ::yhs_can_msgs::ctrl_cmd_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::yhs_can_msgs::ctrl_cmd_<ContainerAllocator>& v)
  {
    ...
    s << indent << "ctrl_cmd_linear: ";
    Printer<float>::stream(s, indent + "  ", v.ctrl_cmd_linear);
    s << indent << "ctrl_cmd_angular: ";
    Printer<float>::stream(s, indent + "  ", v.ctrl_cmd_angular);
    s << indent << "ctrl_cmd_slipangle: ";
    Printer<float>::stream(s, indent + "  ", v.ctrl_cmd_slipangle);
  }
};
